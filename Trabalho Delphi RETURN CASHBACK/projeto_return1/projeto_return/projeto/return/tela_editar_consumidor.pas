...
procedure Tform_editar_consumidor.Button1Click(Sender: TObject);
begin
var i : integer;
for i := 0 to form_editar_consumidor.ComponentCount -1 do
begin
if form_editar_consumidor.Components[i] is TEdit then
TEdit(form_editar_consumidor.Components[i]).Clear;
end;
end;

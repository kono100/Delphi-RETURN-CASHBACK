...
procedure Tform_cadastro_consumidor.btn_limparClick(Sender: TObject);
begin
var i : integer;
for i := 0 to form_cadastro_consumidor.ComponentCount -1 do
begin
if form_cadastro_consumidor.Components[i] is TEdit then
TEdit(form_cadastro_consumidor.Components[i]).Clear;
end;
end;

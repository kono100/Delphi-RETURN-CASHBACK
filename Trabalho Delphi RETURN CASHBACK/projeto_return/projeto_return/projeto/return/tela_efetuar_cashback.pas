...
begin
  ...
  //puxando informações do percentual
...
procedure Ttela_efetuar_cashbar.Button1Click(Sender: TObject);
begin
var i : integer;
for i := 0 to tela_efetuar_cashbar.ComponentCount -1 do
begin
if tela_efetuar_cashbar.Components[i] is TEdit then
TEdit(tela_efetuar_cashbar.Components[i]).Clear;
end;
end;
